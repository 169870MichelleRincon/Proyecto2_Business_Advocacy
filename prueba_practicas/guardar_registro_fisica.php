...
//los datos del titular y apoderado se consideran los mismos para este tipo de personas
        ...
        //direccion
        $Direccion_apoderado = mysqli_query($conn, "INSERT INTO `direccion_detalles`(`calle`, `num_int`, `num_ext`, `pais`, `cp`, `colonia`, `id_municipio`, `id_estado`) VALUES ('$calle_t','$num_int_t','$num_ext_t','Mexico','$cp_t','$colonia_t','$municipio_t','$estado_t');");
        //traer id que se registro del direccion titular
        ...
        //datos del titular
        $apoderado = mysqli_query($conn, "INSERT INTO `titular`(`rfc`, `nombre`, `apellido_pat`, `apellido_mat`, `correo`, `id_tipo`, `id_direccion`, `fax`, `telefono`) VALUES ('$rfc_t','$nombre_t','$apellidoPat_t','$apellidoMat_t','$correo_t','$tipo','$id_direccionT_registrada','$fax_t','$telefono_t')");
